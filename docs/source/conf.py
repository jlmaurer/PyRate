...
project = u'PyRate'
copyright = u'2016, PyRate Team'
author = u'PyRate Team'
...
latex_documents = [
    (master_doc, 'PyRate.tex', u'PyRate Documentation',
     u'PyRate Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyrate', u'PyRate Documentation',
     [author], 1)
]
